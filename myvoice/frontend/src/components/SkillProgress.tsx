import { type Skill, calculateSkillLevel, getSkillLevelDescription, getCategoryColor } from "@/lib/skillsData";
        ...
        <div className="bt-card p-4">
            ...
            <div className="mb-2">
                <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm font-bold text-[var(--bt-primary)]">
                        {skill.unit === "score_0_100" ? `${currentValue}점` : `레벨 ${currentValue}`}
                    </span>
                </div>
                <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
                    <div
                        className="h-full bg-gradient-to-r from-[var(--bt-primary)] to-green-400 transition-all duration-500"
